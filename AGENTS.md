...
- `docs/release-procedure.md` — the evidence-based procedure for cutting a release: pre-tag checks, the version decision, the changelog step, building and publishing the archive, and the coordinated case with `kntnt-wp-skills`

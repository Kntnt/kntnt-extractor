# Contributing to Kntnt Extractor

Thanks for considering a contribution. Kntnt Extractor is open source, so anyone is free to fork it and adapt it for their own purposes. This document describes the *project norm* — what kinds of contribution are likely to be welcomed into the upstream repository at [Kntnt/kntnt-extractor](https://github.com/Kntnt/kntnt-extractor). It is editorial guidance on what is likely to be merged, not a legal restriction on what you may do with the code.
...
By submitting a contribution, you agree to license it under the project's licence. No separate contributor licence agreement is required.
...
1. **Open an issue first** for anything in the *discussed* row above. For *welcomed* items, you can open a PR directly. Use the issue tracker at <https://github.com/Kntnt/kntnt-extractor/issues>.

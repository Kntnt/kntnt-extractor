...
- **8 MiB is not merely suboptimal, it is dangerous.** It sits far past a threshold that turns a slow run into an impossible one, and it is the shipped default.
